        ...
        >
            <View style={styles.frame}>
                <View style={styles.container}>
                    ...
                    <ButtonSelection bgEasy function={() => props.onLevelSelected(0.1)} />
                    <ButtonSelection bgNormal function={() => props.onLevelSelected(0.2)} />
                    <ButtonSelection bgHard function={() => props.onLevelSelected(0.3)} />
                </View>
            </View>
        </Modal>
    )
